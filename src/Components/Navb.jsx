      ...
      <div className="container-fluid col-10">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          className="nav-link active" aria-current="page" to="/">Home</NavLink>
            ...
            <li className="nav-item">
              <NavLink style={navLinkStyles} to="movies" className="nav-link">Movies</NavLink>
            </li>
            <li className="nav-item">
            <NavLink style={navLinkStyles} to="stream" className="nav-link">Stream</NavLink>
            </li>
            <li>
            <NavLink style={navLinkStyles} to="events" className="nav-link">Events</NavLink>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a className="dropdown-item" href="https://play.google.com/store/games?utm_source=apac_med&utm_medium=hasem&utm_content=Oct0121&utm_campaign=Evergreen&pcampaignid=MKT-EDR-apac-in-1003227-med-hasem-py-Evergreen-Oct0121-Text_Search_BKWS-BKWS%7CONSEM_kwid_43700058906718349_creativeid_480977734745_device_c&gclid=CjwKCAiA3pugBhAwEiwAWFzwdQUICCEyI8FDs2f4qn3kP3SLBGG2aCKqOdhXB6vICBjThAN5WcCqRxoCrigQAvD_BwE&gclsrc=aw.ds&pli=1">Plays</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/explore/sports-kochi">Activities</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/buzz">Buzz</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/list-your-show/">ListyourShow</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/voucher">Corporates</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/offers">Offers</a></li>
                <li><a className="dropdown-item" href="https://in.bookmyshow.com/giftcards">Gift Cards</a></li>
              </ul>
            </li>
          </ul>

        </div>
      <NavLink to="signup"><button className="btn btn-outline-success" type="submit">Sign up</button></NavLink>
      </div>
    </nav>
  )
}
